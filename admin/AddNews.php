  ...
  <body>
    ...
    <?Php
      ...
      if(isset($_GET["content"])){
        // content passed from feeds.php or forums.php
        $content = '<blockquote>'.convert_html_to_text($_GET["content"]).'</blockquote>';
        ...
        //URL passed by bookmarklet
        $content='<blockquote>'.myTruncate(convert_html_to_text($aryContent['content']), 250).'</blockquote>';
      }
?>
