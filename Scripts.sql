...
CREATE TABLE tmptable_1 SELECT * FROM DataAddons WHERE PlanID = 720;
ALTER TABLE tmptable_1 MODIFY DataAddonID int(11) null;
UPDATE tmptable_1 SET DataAddonID = NULL, PlanID = 722;
INSERT INTO DataAddons SELECT * FROM tmptable_1;
DROP TABLE IF EXISTS tmptable_1;

CREATE TABLE tmptable_1 SELECT * FROM FamilyPlans WHERE PlanID = 720;
ALTER TABLE tmptable_1 MODIFY FamilyPlanID int(11) null;
UPDATE tmptable_1 SET FamilyPlanID = NULL, PlanID = 721;
